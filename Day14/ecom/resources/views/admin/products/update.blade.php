            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box_general padding_bottom">
                        ...
                        <form action="{{ URL::route('admin.products.update.save', $data->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="category" required value="{{ $data->category }}">
                            </div> 
                            <div class="form-group">
                                <label>Price</label>
